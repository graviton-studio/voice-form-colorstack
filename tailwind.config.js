  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Keep rose colors for backward compatibility and specific components that might still use it
        rose: {
          50: "#fff1f2",
          100: "#ffe4e6",
          200: "#fecdd3",
      ...
      boxShadow: {
        ...
        'light-lg': '0 10px 25px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.03)',
