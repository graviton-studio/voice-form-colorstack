  ...
  if (completed) {
    return (
      <div className="max-w-2xl mx-auto text-center space-y-8">
        ...
        <p className="text-xl text-slate-300">Thank you for completing the form using your voice.</p>
        <div className="bg-slate-800 rounded-lg p-6 text-left">
          ...
          <div className="space-y-4">
            {answers.map((answer, index) => {
              ...
              return (
                <div key={answer.questionId} className="border-b border-slate-700 pb-3">
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <Button variant="ghost" size="sm" className="mt-1 text-slate-400" onClick={speakQuestion}>
          ...
          <div className="flex items-center justify-between">
            <Button variant={isListening ? "destructive" : "outline"} onClick={toggleListening} className="gap-2">
              {isListening ? (
                <>
            ...
            <Button onClick={submitAnswer} disabled={!transcript.trim()} className="gap-2">
              Next Question
